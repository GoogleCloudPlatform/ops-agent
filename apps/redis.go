...
type LoggingProcessorMacroRedis struct {
}

func (LoggingProcessorMacroRedis) Type() string {
	return "redis"
}

func (p LoggingProcessorMacroRedis) Expand(ctx context.Context) []confgenerator.InternalLoggingProcessor {
