...
type LoggingProcessorMacroHadoop struct{}

func (LoggingProcessorMacroHadoop) Type() string {
	return "hadoop"
}

func (p LoggingProcessorMacroHadoop) Expand(ctx context.Context) []confgenerator.InternalLoggingProcessor {
	// Sample log line:
...
func loggingReceiverFilesMixinHadoop() confgenerator.LoggingReceiverFilesMixin {
...
func init() {
	confgenerator.RegisterLoggingFilesProcessorMacro[LoggingProcessorMacroHadoop](loggingReceiverFilesMixinHadoop)
}
