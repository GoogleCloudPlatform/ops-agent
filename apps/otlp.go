			...
			Config: map[string]interface{}{
				...
				"metric_statements": []map[string]interface{}{{
					...
					"statements": []string{
						...
						stmt(`attributes["location"]`, `resource.attributes["cloud.region"]`, "gcp_bare_metal_solution"),
						// namespace = host.id
						stmt(`attributes["namespace"]`, `resource.attributes["host.id"]`, "gcp_bare_metal_solution"),
						// cluster = "__bms__"
						stmt(`attributes["cluster"]`, `"__bms__"`, "gcp_bare_metal_solution"),
						// instance_name = host.id
						stmt(`attributes["instance_name"]`, `resource.attributes["host.id"]`, "gcp_bare_metal_solution"),
