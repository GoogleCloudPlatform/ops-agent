#!/bin/bash
# setup_gpu_apps.sh - Provisioning script for Packer on Rocky Linux 9, executed via Shell Provisioner.
set -euo pipefail

echo "--- Starting Packer Provisioning on Rocky Linux 9 $(date) ---"
...
# --- NVIDIA Repository Setup for Rocky Linux 9 ---
echo "--- Configuring NVIDIA CUDA Repository for Rocky Linux 9 ---"
