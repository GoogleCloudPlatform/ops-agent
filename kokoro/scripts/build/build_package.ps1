...
if ($env:_LOUHI_EXECUTION_ID -ne $null) {
  $result_dir="$env:KOKORO_ARTIFACTS_DIR/result/louhi/${env:_LOUHI_EXECUTION_ID}"
}
else {
  $result_dir="$env:KOKORO_ARTIFACTS_DIR/result/${env:KOKORO_JOB_NAME}/${env:KOKORO_BUILD_ID}"
}
...
# Copy the .goo file from $env:KOKORO_ARTIFACTS_DIR/out to $result_dir.
...
Move-Item -Path "$env:KOKORO_ARTIFACTS_DIR/out/*.goo" -Destination "$result_dir"
...
Move-Item -Path "$env:KOKORO_ARTIFACTS_DIR/out/bin/*.pdb" -Destination "$result_dir"
Move-Item -Path "$env:KOKORO_ARTIFACTS_DIR/out/bin/*.dll" -Destination "$result_dir"
