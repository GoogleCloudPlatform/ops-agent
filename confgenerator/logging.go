...
func stackdriverOutputComponent(match, userAgent string, bufferLimitSize int) fluentbit.Component {
	...
	if bufferLimitSize > -1 {
		config["storage.total_limit_size"] = fmt.Sprintf("%dM", bufferLimitSize)
	}
