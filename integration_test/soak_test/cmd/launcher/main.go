...
DISTRO: The Image Spec to run the tests on, e.g. "debian-cloud:debian-12".

VM_NAME: (Optional) The name of the VM to spawn. If not supplied,
a random name will be generated by gce_testing.go.

FEATURE: (Optional) The ops agent "EXPERIMENTAL_FEATURES" to be enabled for
this soak test. If not supplied, no experimental flags are passed.
